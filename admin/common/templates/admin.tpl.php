 ...
 * This is all edited by hand, unlike the main template files which are
 * generated with code.
 *
...
END;
	...
	function admin_menu()
	{
		...
		$return .= $this -> generate_menu_entry($lang['admin_menu_import_export_avatars'], l("admin/avatars/backup/"));
		...
		$return .= $this -> generate_menu_entry($lang['admin_menu_import_export_post_icons'], l("admin/post_icons/backup/"));
